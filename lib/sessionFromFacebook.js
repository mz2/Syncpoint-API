...
function newSessionRequested(newSessionRequestedDoc) {
    var fbMeUrl = "https://graph.facebook.com/me?access_token="+
        newSessionRequestedDoc.fb_access_token;
    coux(fbMeUrl, function(err, resp) {
        if (err) {
        ...
        if (resp.id && resp.name) {
            ...
            // todo rename these to what they do, not what they have
            // maybe use a flow control library?
            // also most of this stuff will be common across pairing plugins
